namespace Mapbox.Examples
{
	...
	public class QuadTreeCameraMovement : MonoBehaviour
	{
		...
		{
			m_proxy.OnScrollEvent += OnScrolled;
		}

        private void OnScrolled(Vector2 scrollDelta)
        {
			ZoomMapUsingTouchOrMouse(scrollDelta.y * 0.1f);
        }
		...
		private void LateUpdate()
		{
			...
			if (!m_proxy.Dragging && _shouldDrag) _shouldDrag = false;
